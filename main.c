/*
 * @Source davidxl/simple_tun_demo
 * Future goals:
 *  - implementing logger (now only a simple prototype, need to log all)
 *  - implementing cryptography (AES maybe)
 *  - implementing UI/Graphical interface for client
 *  - implementing autoinstallation on server like a service
 *  - implementing formatted config to simple importing on client
 */
